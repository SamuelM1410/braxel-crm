...
import { companyListInput, companyIdInput, companyOptionsInput, companyCreateInput, companyUpdateArgs, companyBulkOwnerInput, companyBulkInput, setPrimaryContactInput, companyLeadReviewInput } from "../companies/companies.contracts";
...
import { setMetaAssistantInput } from "../meta/meta.contracts";
...
const appRouter = t.router({
  ...
  companies: t.router({
    ...
    reviewLead: publicProcedure
      .input(companyLeadReviewInput)
      .mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as unknown as Awaited<ReturnType<CompaniesRouter["reviewLead"]>>)
    }),
  contacts: t.router({
    list: publicProcedure
  ...
  google: t.router({
    ...
    sendApprovedEmail: publicProcedure
      .input(sendApprovedEmailInput)
      .mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as unknown as Awaited<ReturnType<GoogleRouter["sendApprovedEmail"]>>),
  ...
  meta: t.router({
    status: publicProcedure
      .query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as unknown as Awaited<ReturnType<MetaRouter["status"]>>),
    setAssistant: publicProcedure
      .input(setMetaAssistantInput)
      .mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as unknown as Awaited<ReturnType<MetaRouter["setAssistant"]>>),
