...
const leadSchema = z.object({
	...
	instagramUrl: z.string().trim().url().max(2048).optional().nullable(),
	facebookUrl: z.string().trim().url().max(2048).optional().nullable(),
	tiktokUrl: z.string().trim().url().max(2048).optional().nullable(),
	whatsappUrl: z.string().trim().url().max(2048).optional().nullable(),
