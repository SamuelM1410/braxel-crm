...
const VERBS: Record<string, string> = {
	...
	list_companies: "Reviewed the companies in the CRM",
	list_outstanding_work: "Looked for outstanding work",
	write_lead_os_dossier: "Wrote the commercial dossier for review",
	read_social_thread: "Read the conversation on the social channel",
	prepare_gmail_reply: "Drafted an email reply for a person to send",
	prepare_meta_reply:
		"Drafted a Facebook or Instagram reply for a person to send",
	prepare_whatsapp_reply: "Drafted a WhatsApp reply for a person to send",
