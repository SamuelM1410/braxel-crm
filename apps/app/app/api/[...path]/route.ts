...
async function handler(request: Request): Promise<Response> {
	...
	// The API runs on :3001 but this route is the browser-facing origin.
	// Forward the public host explicitly so auth validates the same origin that
	// issued the cookies and received the OAuth callback.
